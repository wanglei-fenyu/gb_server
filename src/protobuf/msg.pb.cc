    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "TestMsg.msg"));
        } else
          goto handle_unusual;
        continue;
      // int32 index = 2;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_person();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "TestMsg.person"));
...
uint8_t* TestMsg::_InternalSerialize(
  ...
  // repeated string person = 3;
  for (int i = 0, n = this->_internal_person_size(); i < n; i++) {
    const auto& s = this->_internal_person(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
...
// @@protoc_insertion_point(message_byte_size_start:TestMsg)
  ...
  // repeated string person = 3;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.person_.size());
  for (int i = 0, n = _impl_.person_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.person_.Get(i));
  }
...
template<> PROTOBUF_NOINLINE ::TestMsg*
Arena::CreateMaybeMessage< ::TestMsg >(Arena* arena) {
  return Arena::CreateMessageInternal< ::TestMsg >(arena);
}
