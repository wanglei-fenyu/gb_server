...
PROTOBUF_CONSTEXPR Meta::Meta(
  ...
  , /*decltype(_impl_.method_)*/int64_t{0}
...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_meta_2eproto[2];
...
const uint32_t TableStruct_meta_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Meta, _impl_.mode_),
  PROTOBUF_FIELD_OFFSET(::Meta, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::Meta, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::Meta, _impl_.method_),
  PROTOBUF_FIELD_OFFSET(::Meta, _impl_.sequence_),
  PROTOBUF_FIELD_OFFSET(::Meta, _impl_.compress_type_),
};
...
const ::_pbi::DescriptorTable descriptor_table_meta_2eproto = {
    false, false, 291, descriptor_table_protodef_meta_2eproto,
    "meta.proto",
...
Meta::Meta(const Meta& from)
  ...
  ::memcpy(&_impl_.mode_, &from._impl_.mode_,
    ...
    reinterpret_cast<char*>(&_impl_.mode_)) + sizeof(_impl_.sequence_));
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          _impl_.method_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Meta::_InternalSerialize(
  ...
  if (this->_internal_method() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(4, this->_internal_method(), target);
  }

  // int64 sequence = 5;
  if (this->_internal_sequence() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(5, this->_internal_sequence(), target);
  }
...
void Meta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_compress_type() != 0) {
    _this->_internal_set_compress_type(from._internal_compress_type());
  }
...
template<> PROTOBUF_NOINLINE ::Meta*
Arena::CreateMaybeMessage< ::Meta >(Arena* arena) {
