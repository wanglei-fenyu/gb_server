...
enum MsgCompressType : int {
  ...
  CompressZlib = 2,
  CompressLZ4 = 3,
  MsgCompressType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  MsgCompressType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum MsgMode : int {
  ...
  Request = 1,
  Response = 2,
  MsgMode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  MsgMode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline ::MsgMode Meta::_internal_mode() const {
  return static_cast< ::MsgMode >(_impl_.mode_);
}
...
inline int32_t Meta::_internal_id() const {
  return _impl_.id_;
}
inline int32_t Meta::id() const {
  // @@protoc_insertion_point(field_get:Meta.id)
  return _internal_id();
}
inline void Meta::_internal_set_id(int32_t value) {
  
  _impl_.id_ = value;
}
inline void Meta::set_id(int32_t value) {
...
inline int32_t Meta::_internal_type() const {
  return _impl_.type_;
}
inline int32_t Meta::type() const {
  // @@protoc_insertion_point(field_get:Meta.type)
  return _internal_type();
}
inline void Meta::_internal_set_type(int32_t value) {
  
  _impl_.type_ = value;
}
inline void Meta::set_type(int32_t value) {
...
inline void Meta::clear_method() {
  _impl_.method_ = int64_t{0};
}
inline int64_t Meta::_internal_method() const {
  return _impl_.method_;
}
inline int64_t Meta::method() const {
  // @@protoc_insertion_point(field_get:Meta.method)
  return _internal_method();
}
inline void Meta::_internal_set_method(int64_t value) {
  
  _impl_.method_ = value;
}
inline void Meta::set_method(int64_t value) {
...
inline int64_t Meta::_internal_sequence() const {
  return _impl_.sequence_;
}
inline int64_t Meta::sequence() const {
  // @@protoc_insertion_point(field_get:Meta.sequence)
  return _internal_sequence();
}
inline void Meta::_internal_set_sequence(int64_t value) {
  
  _impl_.sequence_ = value;
}
inline void Meta::set_sequence(int64_t value) {
...
inline ::MsgCompressType Meta::_internal_compress_type() const {
  return static_cast< ::MsgCompressType >(_impl_.compress_type_);
}
